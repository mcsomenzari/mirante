...
namespace Questao1 {
    class Program {
        private static readonly decimal taxaSaque = 3.50M;
        ...
        static void Main(string[] args) {
            ...
            if (resp == 's' || resp == 'S') {
                ...
                conta = new ContaBancaria(numero, titular, (decimal)depositoInicial);
            }
            else {
            ...
            conta.Deposito((decimal)quantia);
            ...
            conta.Saque((decimal)quantia, taxaSaque);
            Console.WriteLine("Dados da conta atualizados:");
            Console.WriteLine(conta);
